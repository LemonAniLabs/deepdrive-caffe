...
#include <include/caffe/layers/fast_rcnn_layers.hpp>
...
//  SmoothL1LossParameter loss_param = this->layer_param_.smooth_l1_loss_param();
  ...
  // Uses sigma = 3.0 -> https://github.com/rbgirshick/py-faster-rcnn/search?p=1&q=smooth&utf8=%E2%9C%93
  sigma2_ = 9; //loss_param.sigma() * loss_param.sigma();
